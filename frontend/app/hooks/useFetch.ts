...
// Standalone fetcher for TanStack Query (and direct use). Robust error parsing for FastAPI/Pydantic responses.
...
// Legacy hook wrapper (kept for compatibility during transition; prefer apiFetch for queries/mutations)
